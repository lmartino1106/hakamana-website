        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-12">
              ...
              <Image src="/images/Ranked-Firm-2022.png" alt="Ranked Firm 2022" width={120} height={120} className="h-20 w-auto opacity-80 hover:opacity-100 transition-opacity" />
              <Image src="/images/RANKED_FIRM_2023_LEADERS.png" alt="Ranked Firm 2023" width={120} height={120} className="h-20 w-auto opacity-80 hover:opacity-100 transition-opacity" />
              <Image src="/images/Chambers-Litigation-Support-2021.jpg" alt="Chambers Litigation Support 2021" width={160} height={100} className="h-16 w-auto opacity-80 hover:opacity-100 transition-opacity" />
            </div>
          </AnimatedSection>
        </div>
      </section>
